...
CREATE PROCEDURE SP_NUMERO_DECIMAL_ALEATORIO(@MIN INT, @MAX INT, @RETORNO DECIMAL(3,2) OUT)
AS 
BEGIN
...
BEGIN
	...
	PRINT @CONT
		...
		BEGIN
			DECLARE 
				 @MENOR_PRECO DECIMAL(4,2)
				,@MAIOR_PRECO DECIMAL(4,2)
